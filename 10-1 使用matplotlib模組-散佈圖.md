...
#有條件部分記錄的單一欄位
#----------------------------------
setosa_SL = df['sepalL'][df['species']=='山鳶尾花']  
setosa_SW = df['sepalW'][df['species']=='山鳶尾花'] 

versicolor_SL = df['sepalL'][df['species']=='變色鳶尾花']  
versicolor_SW = df['sepalW'][df['species']=='變色鳶尾花'] 

virginica_SL = df['sepalL'][df['species']=='維吉尼亞鳶尾花']  
virginica_SW = df['sepalW'][df['species']=='維吉尼亞鳶尾花'] 
...
# 繪製資料
#---------------------------
sub.plot(setosa_SL, setosa_SW, 'bd', alpha=0.2)
sub.plot(versicolor_SL, versicolor_SW, 'ro', alpha=0.2)
sub.plot(virginica_SL, virginica_SW, 'gs', alpha=0.2)
