...
以下是一個讀入「iris.csv」檔案, 選擇資料成為兩個dataframe, 再合併成一個的例子:

## [範例-1] 畫面示例
![GitHub Logo](/images/06-6-1.jpg)
...
#選取某些記錄的所有欄位
df1=df.loc[(df['sepalL'] >= 4) & (df['sepalL'] <= 5)]
df2=df.loc[(df['sepalW'] >= 5) & (df['sepalW'] <= 6)]
...
11      4.8     3.4     1.6     0.2     山鳶尾花
12      4.8     3.0     1.4     0.1     山鳶尾花
13      4.3     3.0     1.1     0.1     山鳶尾花
22      4.6     3.6     1.0     0.2     山鳶尾花
24      4.8     3.4     1.9     0.2     山鳶尾花
25      5.0     3.0     1.6     0.2     山鳶尾花
26      5.0     3.4     1.6     0.4     山鳶尾花
29      4.7     3.2     1.6     0.2     山鳶尾花
30      4.8     3.1     1.6     0.2     山鳶尾花
...(略)
```
