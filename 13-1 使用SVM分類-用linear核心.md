# 13-1 使用SVM分類-用linear核心

### 找一個最大的超平面將資料分開.


## [範例-1] 畫面示例
![GitHub Logo](/images/13-1-1.jpg)
...
```
正確: [2. 1. 3. 3. 3. 3. 2. 2. 3. 1. 2. 1. 3. 3. 1. 2. 3. 3. 2. 3. 1. 1. 2. 1.
 3. 1. 3. 3. 2. 2.]

預測: [2. 1. 3. 3. 3. 3. 2. 2. 3. 1. 2. 1. 3. 3. 1. 2. 3. 2. 2. 2. 1. 1. 2. 1.
 2. 1. 3. 3. 2. 2.]
