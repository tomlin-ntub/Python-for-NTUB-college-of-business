...
以下是一個讀入「iris.csv」檔案, 選擇部分內容後, 寫到output.csv的例子:

## [範例-1] 畫面示例
![GitHub Logo](/images/06-5-1.jpg)
...
#選取某些記錄的所有欄位
df2=df.loc[(df['sepalL'] >= 6) & (df['sepalL'] <= 7)]

#將data frame內容輸出到CSV檔案
df2.to_csv('output.csv', sep=',', encoding='utf-8')
```

## [範例-1] 執行結果(output.csv)
```
...
77,6.7,3.0,5.0,1.7,變色鳶尾花
78,6.0,2.9,4.5,1.5,變色鳶尾花
83,6.0,2.7,5.1,1.6,變色鳶尾花
85,6.0,3.4,4.5,1.6,變色鳶尾花
86,6.7,3.1,4.7,1.5,變色鳶尾花
87,6.3,2.3,4.4,1.3,變色鳶尾花
91,6.1,3.0,4.6,1.4,變色鳶尾花
97,6.2,2.9,4.3,1.3,變色鳶尾花
100,6.3,3.3,6.0,2.5,維吉尼亞鳶尾花
...(略)
```
